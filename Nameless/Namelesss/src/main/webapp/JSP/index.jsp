			...
			<form class="formulario" method="get" action="./indexServlet">
		      ...
		      <table border = "0">
		        <tr><td><label>Usuario </label></td>
							  <td><input type="text" maxlength="50" name="txtUsuario" id="txtUsuario" size ="50" placeholder="Digite el usuario" required></td>
						</tr>
						<tr>
								<td><label>Contraseña </label></td>
								<td><input type="password" maxlength="50" name="txtPassword" id="txtPassword" placeholder="Contraseña" required></td>
						</tr>
							<tr>
								<td></td>
